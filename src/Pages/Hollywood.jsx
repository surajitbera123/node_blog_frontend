...
export default function Hollywood() {
  ...
  useEffect(() => {
    fetch("https://backend-blog-m30ykmw2m-surajitbera123.vercel.app/hollywoodPost")
      .then((res) => res.json()).then((json) => setPost(json));
  }, []);

  useEffect(() => {
    fetch("https://backend-blog-m30ykmw2m-surajitbera123.vercel.app/hollywoodFirstPost")
      .then((res) => res.json()).then((json) => setFirstPost(json));
  }, []);

  useEffect(() => {
    fetch("https://backend-blog-m30ykmw2m-surajitbera123.vercel.app/hollywoodTopPost")
